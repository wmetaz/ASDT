...
if __name__ == '__main__':
    ...
    parser.add_argument("--out_la_crf", default='./output/result/crf/exp1/rrm_18000_max_vis', type=str)
    ...
    for i in img_list:
        ...
        if args.out_la_crf is not None:
            ...
            save_path = os.path.join(args.out_la_crf, i[:-1] + '.png')

            #plt.imsave(save_path, crf_img.astype(np.uint8))

            utils.labelTopng(crf_img, save_path)
