...
if __name__ == '__main__':
    ...
    parser.add_argument("--out_la_crf", default='./output/result/crf/exp1/rrm_18000_max_test', type=str)
    ...
    for i in img_list:
        ...
        img_temp = cv2.imread(os.path.join(im_path, tmp + '.jpg'))
        ...
        if args.out_la_crf is not None:
            ...
            imageio.imsave(os.path.join(args.out_la_crf, tmp + '.png'), crf_img.astype(np.uint8))
